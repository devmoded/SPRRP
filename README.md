...
# Установка
Для скачивания сборки можнео использовать мою программу [Modpack Downloader](https://github.com/devmoded/modpack_downloader)

А дальше следовать инструкции (пока инструкции нет)
